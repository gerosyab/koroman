...
**KOROMAN** is a multilingual Romanizer for Korean text, strictly following the **Latest Revised Romanization system ([Notice 2024-27](https://github.com/whoshe/koroman/blob/master/docs/notice_2024_27.md))** and the legacy standard (Notice 2000-8). It supports **JavaScript, Python, and Java** with a unified core engine.
